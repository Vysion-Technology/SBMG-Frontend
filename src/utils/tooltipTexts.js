...
export const TOOLTIP_TEXTS = {
  ...
  "FUND_UTILIZATION_RATE": "Percentage of sanctioned funds utilized through work orders. Formula: (Total Work Order Amount / Total Funds Sanctioned) × 100. Example: ₹75 L used out of ₹100 L = 75%.",

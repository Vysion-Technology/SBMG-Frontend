...
import { Plus, Calendar, ChevronDown, X, Upload, MapPin, Search, Truck, Circle, AlertCircle } from 'lucide-react';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Map Labels (Simulated Location Names) */}
            <div style={{
              position: 'absolute',
              top: '15%',
              left: '35%',

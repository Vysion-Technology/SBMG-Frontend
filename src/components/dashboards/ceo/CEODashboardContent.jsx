...
const CEODashboardContent = () => {
  ...
  // Overview stats (Districts, Blocks, Villages)
  const [overviewStats, setOverviewStats] = useState({ districts: 1, blocks: 0, villages: 0 });
  ...
  // Update overview stats when blocks load (CEO: 1 district, N blocks; villages from API or 0)
  useEffect(() => {
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          <OverviewBanner
            districtsCount={overviewStats.districts}
            blocksCount={overviewStats.blocks}
            villagesCount={overviewStats.villages}
          />
        </div>
      </div>
